...
Partial Class AddMetroApp
    ...
    Private Sub InitializeComponent()
        ...
        Me.LicensePath = New DismGui.FileOrFolderSelector()
        Me.CustomDataPath = New DismGui.FileOrFolderSelector()
        Me.PackagePath = New DismGui.FileOrFolderSelector()
        Me.FolderPath = New DismGui.FileOrFolderSelector()
        ...
        'LicensePath
        '
        Me.LicensePath.BrowserStyle = DismGui.FileOrFolderBrowserStyle.FileOpen
        ...
        'CustomDataPath
        '
        Me.CustomDataPath.BrowserStyle = DismGui.FileOrFolderBrowserStyle.FileOpen
        ...
        'PackagePath
        '
        Me.PackagePath.BrowserStyle = DismGui.FileOrFolderBrowserStyle.FileOpen
        ...
        'FolderPath
        '
        Me.FolderPath.BrowserStyle = DismGui.FileOrFolderBrowserStyle.Folder
    ...
    Friend WithEvents FolderPath As DismGui.FileOrFolderSelector
    ...
    Friend WithEvents PackagePath As DismGui.FileOrFolderSelector
    ...
    Friend WithEvents LicensePath As DismGui.FileOrFolderSelector
    Friend WithEvents CustomDataPath As DismGui.FileOrFolderSelector
