Public Class PanelEdition
    ...
    Friend WithEvents MSKey As DismGui.MSProductKeyBox
    ...
    Private Sub InitializeComponent()
        ...
        Me.MSKey = New DismGui.MSProductKeyBox()
        Me.SuspendLayout()
        '
        'BtnRefresh
        '
        ...
        Me.MountedWimInfo.ListSelectedItemDetail = DismGui.WimInfoDetail.Edition
